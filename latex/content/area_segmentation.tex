...
% U-Net: ~9s for each image
% DenseNet: ~11s for each image

\WIP{
for Unet, relation to label is clearly visible. general outlines of classes look very similar. especially for classes buildings, forest, agriculture. this is expected, because those are the dominant classes in the data set. for those, there is lots of good training examples available.
