...
\begin{figure}[h]
    ...
    {\textbf{Schematic View of a Perceptron}~\cite[p.~257, modified]{praxiseinstieg_ml17}. All inputs are combined with an input function. The net input is then passed to an activation function to produce the output.}
