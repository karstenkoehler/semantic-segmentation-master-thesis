...
\begin{figure}[h]
    ...
    {\textbf{Drawbacks for Categorical Accuracy regarding Dominant Classes}~\cite{tds_segmentation18}. (\subref{fig:ca_image})~Original Image.  (\subref{fig:ca_truth})~Ground Truth with \texttt{boat} and \texttt{background} classes. (\subref{fig:ca_prediction})~Exemplary prediction with high categorical accuracy.}
